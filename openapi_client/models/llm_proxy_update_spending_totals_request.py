...
class LLMProxyUpdateSpendingTotalsRequest(BaseModel):
    """
    LLMProxyUpdateSpendingTotalsRequest
    """ # noqa: E501
    models: Optional[List[Llmproxyv1Model]] = Field(default=None, description="Spend cap and totals for each model are deltas so that the client cannot alter usage metrics.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "models": [Llmproxyv1Model.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None
        })
        return _obj
