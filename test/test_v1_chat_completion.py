...
class TestV1ChatCompletion(unittest.TestCase):
    """V1ChatCompletion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ChatCompletion:
        """Test V1ChatCompletion
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ChatCompletion`
        """
        model = V1ChatCompletion()
        if include_optional:
            return V1ChatCompletion(
                id = '',
                external_id = '',
                model = '',
