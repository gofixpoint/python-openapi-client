...
class V1AppLog(BaseModel):
    """
    V1AppLog
    """ # noqa: E501
    name: Optional[StrictStr] = None
    trace_id: Optional[StrictStr] = Field(default=None, alias="traceId")
    level: Optional[AppLogLevelType] = None
    message: Optional[StrictStr] = None
    additional_info: Optional[Dict[str, Any]] = Field(default=None, alias="additionalInfo")
    event_timestamp: Optional[datetime] = Field(default=None, alias="eventTimestamp")
    __properties: ClassVar[List[str]] = ["name", "traceId", "level", "message", "additionalInfo", "eventTimestamp"]
