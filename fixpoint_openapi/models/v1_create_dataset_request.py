...
class V1CreateDatasetRequest(BaseModel):
    """
    V1CreateDatasetRequest
    """ # noqa: E501
    display_name: Optional[StrictStr] = Field(default=None, alias="displayName")
    description: Optional[StrictStr] = None
    log_ids: Optional[List[StrictStr]] = Field(default=None, alias="logIds")
    mode: Optional[V1Mode] = None
    __properties: ClassVar[List[str]] = ["displayName", "description", "logIds", "mode"]
