...
class V1ListLogAttributesResponse(BaseModel):
    """
    V1ListLogAttributesResponse
    """ # noqa: E501
    log_attributes: Optional[List[V1LogAttribute]] = Field(default=None, alias="logAttributes")
    __properties: ClassVar[List[str]] = ["logAttributes"]
