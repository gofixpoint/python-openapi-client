...
class V1CreateDatasetResponse(BaseModel):
    """
    V1CreateDatasetResponse
    """ # noqa: E501
    dataset: Optional[V1Dataset] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dataset": V1Dataset.from_dict(obj["dataset"]) if obj.get("dataset") is not None else None
        })
        return _obj
