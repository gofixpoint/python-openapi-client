...
class Llmproxyv1Model(BaseModel):
    """
    Llmproxyv1Model
    """ # noqa: E501
    provider: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    spend_cap: Optional[V1SpendCap] = Field(default=None, alias="spendCap")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "spendCap": V1SpendCap.from_dict(obj["spendCap"]) if obj.get("spendCap") is not None else None,
