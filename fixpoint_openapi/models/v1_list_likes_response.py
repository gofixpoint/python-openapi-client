...
class V1ListLikesResponse(BaseModel):
    """
    V1ListLikesResponse
    """ # noqa: E501
    likes: Optional[List[V1Like]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "likes": [V1Like.from_dict(_item) for _item in obj["likes"]] if obj.get("likes") is not None else None
        })
        return _obj
