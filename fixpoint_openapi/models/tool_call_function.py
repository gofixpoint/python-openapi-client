...
class ToolCallFunction(BaseModel):
    ...
    arguments: Optional[StrictStr] = Field(default=None, description="A JSON string of the arguments. Note, it's possible that the AI does not generate valid JSON.")
