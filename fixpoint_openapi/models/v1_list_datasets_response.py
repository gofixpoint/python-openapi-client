...
class V1ListDatasetsResponse(BaseModel):
    """
    V1ListDatasetsResponse
    """ # noqa: E501
    datasets: Optional[List[V1Dataset]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "datasets": [V1Dataset.from_dict(_item) for _item in obj["datasets"]] if obj.get("datasets") is not None else None
        })
        return _obj
